...
class ScriptHandler {
  ...
  // Adapted from prepareForPantheon().
  // 1. Removes .git directories
  // 2. Removes everything about the ::: cut ::: line and leaves the rest. 
  public static function prepareForBuild()
  {
