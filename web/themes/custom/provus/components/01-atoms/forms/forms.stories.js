...
import facetCheckbox from './facet-checkbox/facet-checkbox.twig';
...
import facetCheckboxData from './facet-checkbox/facet-checkbox.yml';
...
export const facetCheckboxes = () => (
  <div dangerouslySetInnerHTML={{ __html: facetCheckbox(facetCheckboxData) }} />);
