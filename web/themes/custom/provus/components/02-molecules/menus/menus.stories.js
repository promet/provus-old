...
import quickMenu from './quick-links-menu/quick-links-menu.twig';
import resourceMenu from './resources-menu/resources-menu.twig';
import mainMenu from './main-menu/main-menu.twig';
import socialMenu from './social/social-menu.twig';
import sidebarMenuStructure from './sidebar-menu/sidebar-menu.twig';

import breadcrumbsData from './breadcrumbs/breadcrumbs.yml';
import inlineMenuData from './inline/inline-menu.yml';
import quickMenuData from './quick-links-menu/quick-links-menu.yml';
import resourceMenuData from './resources-menu/resources-menu.yml';
...
export const quickLinksMenu = () => (
  <div dangerouslySetInnerHTML={{ __html: quickMenu(quickMenuData) }} />);
export const resourcesMenu = () => (
  <div dangerouslySetInnerHTML={{ __html: resourceMenu(resourceMenuData) }} />);
export const main = () => {
...
export const sidebarMenu = () => (
  <div dangerouslySetInnerHTML={{ __html: sidebarMenuStructure(sidebarMenuData) }} />);
